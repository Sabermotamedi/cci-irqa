        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cr_Number = table.Column<string>(nullable: true),
                    Fax_No = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true),
                    Website = table.Column<string>(nullable: true),
                    Membership_Date = table.Column<string>(nullable: true),
                    Membership_Renew_Date = table.Column<string>(nullable: true),
                    Membership_Next_RenewDdate = table.Column<string>(nullable: true),
                    Company_Type = table.Column<string>(nullable: true),
                    Contact_Person_Ar = table.Column<string>(nullable: true),
                    Contact_Person_En = table.Column<string>(nullable: true),
                    Address_En = table.Column<string>(nullable: true),
                    Address_Ar = table.Column<string>(nullable: true),
                    City_Name_Ar = table.Column<string>(nullable: true),
                    City_Name_En = table.Column<string>(nullable: true),
